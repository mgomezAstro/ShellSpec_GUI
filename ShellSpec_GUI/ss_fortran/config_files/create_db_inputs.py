...
class CreateInputsDB(object):
    ...
    def _defult_columns_types(self):
        inputs_dict = {'ID': ['INT PRIMARY KEY', 1],
                       ...
                       'alam1': ['FLOAT(9,2) NOT NULL', 20000.0],
                       'alamn': ['FLOAT(9,2) NOT NULL', 300000.0],
                       'alams': ['FLOAT(6,2) NOT NULL', 5000.0],
                       ...
                       'ior': ['INT NOT NULL', 0],
                       'iot': ['INT NOT NULL', 0],
                       'offset': ['FLOAT(4,2) NOT NULL', 0],
                       'phase1': ['INT NOT NULL', 0],
                       'phasen': ['INT NOT NULL', 360],
                       'nphase': ['INT NOT NULL', 21],
                       'dinc': ['FLOAT(4,2) NOT NULL', 90.0],
                       'dd': ['FLOAT(8,3) NOT NULL', 500.0],
                       ...
                       'rmdx1': ['FLOAT(5,3) NOT NULL', -5.0],
                       'rmdx2': ['FLOAT(5,3) NOT NULL', 5.0],
                       'rmdy1': ['FLOAT(5,3) NOT NULL', -5.0],
                       'rmdy2': ['FLOAT(5,3) NOT NULL', 5.0],
                       'rmdz1': ['FLOAT(5,3) NOT NULL', -5.0],
                       'rmdz2': ['FLOAT(5,3) NOT NULL', 5.0],
                       'rmdz3': ['FLOAT(5,3) NOT NULL', 0.0],
                       'rmdz4': ['FLOAT(5,3) NOT NULL', 0.0],
                       'steps': ['FLOAT(5,3) NOT NULL', 0.2],
                       'stepsz': ['FLOAT(5,3) NOT NULL', 0.2],
                       'gainx': ['FLOAT(5,3) NOT NULL', 1.0],
                       'gainy': ['FLOAT(5,3) NOT NULL', 1.0],
                       'gainz': ['FLOAT(5,3) NOT NULL', 1.0],
                       ...
                       'xsm': ['FLOAT NOT NULL', 0.0],
                       'ysm': ['FLOAT NOT NULL', 0.0],
                       'zsm': ['FLOAT NOT NULL', 0.0],
                       'psm': ['FLOAT NOT NULL', 0.0],
