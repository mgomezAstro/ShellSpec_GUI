...
'shellspectrumold39b' using 2:($3+0.) with points
pause-1 "Press Enter"

plot 'shellspectrum' using 2:5 with lines,\
'shellspectrumold39b' using 2:($5+0.) with lines
pause-1 "Press Enter"

#set yrange[-1.:]
set xlabel "lambda"
plot 'shellspectrum' using 1:6 with lines,\
'shellspectrumold39b' using 1:($6+0.) with lines
pause-1 "Press Enter"
...
set grid
set view 40,7
splot 'lightcurve' using ($1+0.):2:3 with lines
pause-1 "Press Enter"
